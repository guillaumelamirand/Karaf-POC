...
public class SelectCommand implements Action
{
	...
	public void setDbSelect(final DbSelect dbSelect)
	{
	...
	{
		final ServiceReference[] dataSources = dbSelect.getDataSources();
		...
		for (final ServiceReference ref : dataSources)
		{
			final List<String> row = table.addRow();
			final DbInfo info = dbSelect.getDataSourceInfo(ref);
